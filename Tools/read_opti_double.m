function [rawData,isLoss,numLoss]=read_opti_double(fileName,timeLength)

%%% This script is used to read the .csv file that records 3D coordinates
%%% data produced by OptiTrack (for double users)
...
INDEX_COLUMN=[INDEX_COLUMN,INDEX_COLUMN+258];
sampleRate=120;
