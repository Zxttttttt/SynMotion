function [raw_data,is_loss,n_loss]=read_opti_double(file_name,time_length)

%%% This script is used to read .csv files that record 3D coordinates
%%% raw data collected by OptiTrack (for double users)
...
i_columns=[i_columns,i_columns+258]; %second person
sample_rate=120;
